...
Event OnGainLOS(Actor akViewer, ObjectReference akTarget)
	...
	; naked, then try to find armor
	Actor _targetActor = akTarget as Actor
	if akViewer.Is3DLoaded() && !akViewer.IsDead() && akViewer.HasKeyWordString("ActorTypeNPC")

		if _targetActor.HasKeyWordString("ActorTypeNPC") && !_targetActor.GetWornForm(0x00000004)			
			akViewer.doSayToVictim(_targetActor)
		endif
	endif
EndEvent
