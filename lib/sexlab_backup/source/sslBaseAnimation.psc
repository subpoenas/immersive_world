...
; collisionDelayStartTime 
; collisionLoopTime
; collisionType vp(0)/vf(1)/vd(3)/ap(4)/af(5)/ad(6)/mp(7)/mf(8)/md(9)/hit(10)
function AddPositionStage(int Position, string AnimationEvent, float forward = 0.0, float side = 0.0, float up = 0.0, float rotate = 0.0, bool silent = false, bool openMouth = false, bool strapon = true, int sos = 0, int collisionDelayStartTime = 1000, int collisionLoopTime = 2000, int collisionType = 0)
	...
	Flags[fid + 5] = collisionDelayStartTime
	Flags[fid + 6] = collisionLoopTime
